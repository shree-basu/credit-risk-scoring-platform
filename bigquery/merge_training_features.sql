MERGE `{{ params.project_id }}.credit_risk_features.training_features` AS target
...
WHEN NOT MATCHED THEN
    INSERT (
        ...
        employment_stability, defaulted, published_at
    )
    VALUES (
        ...
        source.employment_stability, source.defaulted, CURRENT_TIMESTAMP()
    );
