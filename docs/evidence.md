...
| Job | Evidence |
|---|---|
| `quality` | Ruff lint/format, Python compile, 29 non-Spark/non-Airflow tests, exact dependency pins, `pip check`, credential-pattern scan, zero-resource defaults, workflow safety scan |
...
| `dagbag` | Both DAGs import under Airflow 2.11.1 and Google provider 19.5.0; dependency, backfill, permanent-DQ, no-auto-promotion, `insert_job`, and Vertex object-instance assertions |
